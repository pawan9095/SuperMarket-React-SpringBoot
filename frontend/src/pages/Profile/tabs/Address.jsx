...
export default function Address({ user }) {
  const [addresses, setAddresses] = useState([
    { id: 1, name: "Home", address: "123 Main St, New York, NY 10001", phone: "(555) 123-4567", isDefault: true },
    { id: 2, name: "Work", address: "456 Park Ave, New York, NY 10016", phone: "(555) 987-6543", isDefault: false },
  ]);
